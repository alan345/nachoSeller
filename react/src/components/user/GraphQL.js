...
export const USER_PRICING_QUERY = gql`
  query GetUserPricing($userId: String!, $forecastSubscriptionToRemove: String, $v: Float!) {
    getUserPricing(userId: $userId, forecastSubscriptionToRemove: $forecastSubscriptionToRemove, v: $v) {
      myDiscount
      sumSubscriptions
      monthlyCost
    }
