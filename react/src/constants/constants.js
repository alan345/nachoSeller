...
export const URL_SERVER_GRAPHQL = (process.env.NODE_ENV === 'development') ? 'http://localhost:4000' : 'http://104.211.51.118:4000'
export const URL_SERVER_MEDIA = (process.env.NODE_ENV === 'development') ? 'http://localhost:5000' : 'http://104.211.51.118:5000'
export const URL_SERVER_REACT = (process.env.NODE_ENV === 'development') ? 'http://localhost:8080' : 'http://demo.nachonacho.com'
